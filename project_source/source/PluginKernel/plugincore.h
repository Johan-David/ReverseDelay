...
private:
	...
	double wetMinLevel_dB = 0.0;
	double wetMaxLevel_dB = 0.0;
	...
	int switchTimeToBPM = 0;
	enum class switchTimeToBPMEnum { SWITCH_OFF,SWITCH_ON };	// to compare: if(compareEnumToInt(switchTimeToBPMEnum::SWITCH_OFF, switchTimeToBPM)) etc... 

	int noteDuration = 0;
	enum class noteDurationEnum { quarter,eight,sixteenth };	// to compare: if(compareEnumToInt(noteDurationEnum::quarter, noteDuration)) etc... 

	int pureReverseEchoMode = 0;
	enum class pureReverseEchoModeEnum { SWITCH_OFF,SWITCH_ON };	// to compare: if(compareEnumToInt(pureReverseEchoModeEnum::SWITCH_OFF, pureReverseEchoMode)) etc... 
